<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EntityAsp.Login" %>

<!DOCTYPE html>
<html lang="en">
<head>
	<title>Satış Yönetim Paneli</title>
	<meta charset="UTF-8">
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" runat="server">
				...
				<div class="container-login100-form-btn">
                    <asp:Button ID="Button1" runat="server" Text="Giriş Yap" CssClass="login100-form-btn"/>
				</div>
